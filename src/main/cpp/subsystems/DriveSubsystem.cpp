...
void DriveSubsystem::Drive(units::meters_per_second_t xSpeed,
                           ...
                           bool fieldRelative, bool noInput45degrees) {
  ...
  if (noInput45degrees == true){//if there is no joystick input, the wheels will go to the 45 degree (X) position
...
frc2::CommandPtr DriveSubsystem::SetDriveSlow(bool slow){
  return this -> Run(
    [this, slow]{
      driveSlow = slow;
  });
